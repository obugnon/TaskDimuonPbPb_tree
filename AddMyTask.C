...
TString outputListNames[] = {"EventHistos"};
...
UInt_t triggerClasses[] = {AliVEvent::kMuonUnlikeLowPt7};
...
TString GetTriggerClassName(UInt_t triggerClass)
{
    ...
    UInt_t availableTriggerClasses[] = {AliVEvent::kINT7inMUON, AliVEvent::kMuonSingleLowPt7, AliVEvent::kMuonSingleHighPt7, AliVEvent::kMuonLikeLowPt7, AliVEvent::kMuonUnlikeLowPt7}; 
